...
<div class="form_container">
    <form role="form" action="<?php echo ROOT_URL?>users/update" method="post" name="editprofileform"
        ...
        <?php if($model['date_birth']==''){?>
            <div class="form-group col-sm-6">
                ...
                <input type="number" class="form-control" id="age" name="age" min="18" max="100"
                       value="<?php echo explode(' ',$model['age'])[0]?>" required>
            </div>
        <?php }?>
        <div class="clearfix"></div>
        <div class="col-sm-8">
        <input type="hidden" name="user" id="user" value="<?php echo $model['name']?>" />
